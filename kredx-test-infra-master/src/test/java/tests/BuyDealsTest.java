...
public class BuyDealsTest extends BaseTest {
    ...
    @Test
    public void insufficientWalletAmountTest(){
        driver.get(data.getUrl());

        LoginPage loginPage = PageFactory.initElements(driver, LoginPage.class);
        loginPage.enterUsername(data.getUsernameLowBalanceAccount())
                .enterPassword(data.getPassword())
                .submit();
        ...
        CurrentDealsPage currentDealsPage = PageFactory.initElements(driver, CurrentDealsPage.class);
        currentDealsPage.inputOverBalanceLimitAmount(data.getOverBalanceLimitAmount())
                        .clickOnSomeGoodEnterpriseBuyNow(data.getDealNameSomeGoodEnterprise());

        DealInterstitialOverlayPage dealInterstitialOverlayPage = PageFactory.initElements(driver, DealInterstitialOverlayPage.class);
        dealInterstitialOverlayPage.clickOnProceedButton();

        Assert.assertEquals(currentDealsPage.getInsufficientBalanceMessage(),data.getInsufficientWalletAmountMessage());
        currentDealsPage.logoutUser();
    }
}
