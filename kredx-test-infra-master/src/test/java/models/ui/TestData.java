...
public class TestData {
    ...
    private String agreementPageHeader;
    private String currentDealsPageText;
    private String dealInterstitialPageText;
    private String overBalanceLimitAmount;
    private String insufficientDealAmountMessage;
    private String usernameLowBalanceAccount;
    private String dealNameSomeGoodEnterprise;
    private String dealsPageText;
    private String valueOfAmountField;
    private String valueAfterClearingAmountField;

    public String getDealNameSomeGoodEnterprise() {
        return dealNameSomeGoodEnterprise;
    }

    public void setDealNameSomeGoodEnterprise(String dealNameSomeGoodEnterprise) {
        this.dealNameSomeGoodEnterprise = dealNameSomeGoodEnterprise;
    }

    public String getUsernameLowBalanceAccount() {
        return usernameLowBalanceAccount;
    }

    public void setUsernameLowBalanceAccount(String usernameLowBalanceAccount) {
        this.usernameLowBalanceAccount = usernameLowBalanceAccount;
    }

    public String getInsufficientWalletAmountMessage() {
        return insufficientDealAmountMessage;
    }

    public void setInsufficientDealAmountMessage(String insufficientDealAmountMessage) {
        this.insufficientDealAmountMessage = insufficientDealAmountMessage;
    }

    public String getOverBalanceLimitAmount() {
        return overBalanceLimitAmount;
    }

    public void setOverBalanceLimitAmount(String overBalanceLimitAmount) {
        this.overBalanceLimitAmount = overBalanceLimitAmount;
    }

    public String getValueAfterClearingAmountField() {
        return valueAfterClearingAmountField;
    }

    public void setValueAfterClearingAmountField(String valueAfterClearingAmountField) {
        this.valueAfterClearingAmountField = valueAfterClearingAmountField;
    }

    public String getValueOfAmountField() {
        return valueOfAmountField;
    }

    public void setValueOfAmountField(String valueOfAmountField) {
        this.valueOfAmountField = valueOfAmountField;
    }

    public String getDealsPageText() {
        return dealsPageText;
    }

    public void setDealsPageText(String dealsPageText) {
        this.dealsPageText = dealsPageText;
    }

    public String getDealInterstitialPageText() {
        return dealInterstitialPageText;
    }

    public void setDealInterstitialPageText(String dealInterstitialPageText) {
        this.dealInterstitialPageText = dealInterstitialPageText;
    }

    public String getCurrentDealsPageText() {
        return currentDealsPageText;
    }

    public void setCurrentDealsPageText(String currentDealsPageText) {
        this.currentDealsPageText = currentDealsPageText;
    }

    public String getAgreementPageHeader() {
        return agreementPageHeader;
    }

    public void setAgreementPageHeader(String agreementPageHeader) {
        this.agreementPageHeader = agreementPageHeader;
    }
